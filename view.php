...
<body>
  <nav>
    ...
    <div class="logo">
      <img src="images/home2.jpeg" width="45" alt="" class="logo-img">
      Habesha Bank
    </div>
    <style>
    .logo-img {
    ...
    <ul>
      <li><a class="active" href="./Admin/admin_home.php">Home</a></li>
      <li><a href="./Admin/admin_Account.php">Accounts</a></li>
      <li><a href="./addNewAccount.php">Add new Account</a></li>
      <li><a href="./Admin/admin_feedback.php">Feedback</a></li>
